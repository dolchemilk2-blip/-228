...
export default {
  ...
  // Страница товара в магазине: кнопка «Купить» открывает её окном поверх сайта. Пусто — кнопки не будет.
  buyUrl: "",
  // Адрес сайта для ссылок из магазина (…/montage/). Пусто — берётся адрес, где открыта админка.
  siteUrl: "",
